...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/RMSE/19_contraceptive_ensemble_method_res.csv'
result_imputation_path = '/userHome/userhome2/hyejin/paper_implementation/res/imputation_res/19_contraceptive_impute_res'
