...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/0_final/30_monk_ensemble_method_res_final.csv'
...
# 데이터 파일 경로 설정
data_pth = '/userHome/userhome2/hyejin/paper_implementation/00_dataset/missing/30_monk.csv'
df_data = pd.read_csv(data_pth)
train_col = ['a1', 'a2', 'a3','a4','a5', 'a6']

prepro_data = '/userHome/userhome2/hyejin/paper_implementation/00_dataset/preprocessing/30_monk.csv'
