...
def main(args):
    ...
    for i  in range(10):
        ...
        print("=== train_X_zero_imputed === ", train_X_zero_imputed.shape)
        print("=== train_y_zero_imputed === ", train_y_zero_imputed.shape)
        print("=== test_X_zero_imputed === ", test_X_zero_imputed.shape)
        print("=== test_y_zero_imputed === ", test_y_zero_imputed.shape)
