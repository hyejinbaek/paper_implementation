...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/RMSE/9_abalone_ensemble_method_res.csv'
result_imputation_path = '/userHome/userhome2/hyejin/paper_implementation/res/imputation_res/9_abalone_impute_res'
