...
# 실행 명령어 : python 14_ensemble_multi+dynamic.py --seed 0 --missing_rate 20 --num_mi 5 --m 10 --tau 0.05
import os
...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/0304/9_abalone_ensemble_method_res.csv'
...
def main(args):
    ...
    for i  in range(30):
        ...
        # 예측값 평균 계산
        avg_predictions = (multi_model + dynamic_imputed_model) / 2
        ...
        result_df = pd.DataFrame({
            'multi_model_imputation': multi_model.flatten(),
    ...
    # CSV 파일로 결과 저장
    pth = '/userHome/userhome2/hyejin/paper_implementation/res/imputation_res/9_abalone_imputation_result.csv'
    result_df.to_csv(pth, index=False)
