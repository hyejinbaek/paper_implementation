...
result_preprocessing_path = '/userHome/userhome2/hyejin/paper_implementation/00_dataset/preprocessing/30_monk.csv'
...
df_data.columns = ['class', 'a1', 'a2', 'a3','a4','a5', 'a6', 'id']
df_data = df_data.drop(labels='id', axis=1)

# df_data = df_data.replace('?', 0).astype(str)
