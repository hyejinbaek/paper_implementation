...
# 실행 명령어 : python 6_ensemble_dynamic+datawig.py --seed 0 --missing_rate 20 --num_mi 5 --m 10 --tau 0.05
import os
...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/0304/12_darwin_ensemble_method_res.csv'
...
def main(args):
    ...
    for i  in range(30):
        ...
        # 예측값 평균 계산
        avg_predictions = (datawig_imputed_model + dynamic_imputed_model) / 2
    ...
    # CSV 파일로 결과 저장
    pth = '/userHome/userhome2/hyejin/paper_implementation/res/imputation_res/12_darwin_imputation_result.csv'
