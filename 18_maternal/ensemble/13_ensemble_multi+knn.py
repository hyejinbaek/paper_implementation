...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/0304/18_maternal_ensemble_method_res.csv'
...
for iteration in range(num_iterations):
    ...
    # CSV 파일로 결과 저장
    pth = '/userHome/userhome2/hyejin/paper_implementation/res/imputation_res/18_maternal_imputation_result.csv'
