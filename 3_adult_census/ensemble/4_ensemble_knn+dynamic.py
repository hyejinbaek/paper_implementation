...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/0304/3_adult_ensemble_method_res.csv'
...
def main(args):
    ...
    # CSV 파일로 결과 저장
    pth = '/userHome/userhome2/hyejin/paper_implementation/res/imputation_res/3_adult_imputation_result.csv'
