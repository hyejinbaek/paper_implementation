...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/0304/1_breast_ensemble_method_res.csv'
...
def main(args):
    ...
    for i  in range(30):
        ...
        print(" === knn_imputed_model === ", knn_imputed_model)
        print(" === dynamic_imputed_model === ", dynamic_imputed_model)
    ...
    # CSV 파일로 결과 저장
    pth = '/userHome/userhome2/hyejin/paper_implementation/res/imputation_res/1_breast_imputation_result.csv'
