...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/0_final/26_diabetes_ensemble_method_res_final.csv'
...
# 데이터 파일 경로 설정
data_pth = '/userHome/userhome2/hyejin/paper_implementation/00_dataset/missing/26_diabetes.csv'
df_data = pd.read_csv(data_pth)
col_data = df_data.columns
train_col = list(col_data)
train_col.remove('class')

prepro_data = '/userHome/userhome2/hyejin/paper_implementation/00_dataset/preprocessing/26_diabetes.csv'
