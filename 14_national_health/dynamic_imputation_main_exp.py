...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/add_rmse/14_national_ensemble_method_res.csv'
...
def main(args):
    ...
    # for문에서 뺌
    x, y = preprocessing(df_data[train_col].values, df_data['age_group'].values, missing_rate, seed)
