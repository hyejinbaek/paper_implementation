...
# 실행 명령어 : python 17_multi+zero+dynamic.py --seed 0 --missing_rate 20 --num_mi 5 --m 10 --tau 0.05
import os
...
def main(args):
    ...
    for i  in range(30):
        ...
        # 예측값 평균 계산
        avg_predictions = (multi_model + zero_imputed_model + dynamic_imputed_model) / 3
