...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/0304/14_national_ensemble_method_res.csv'
...
for iteration in range(num_iterations):
    ...
    # 학습을 위한 데이터 준비
    train_X_knn_imputed = train_data_knn_imputed.drop(columns=['age_group'])
    train_y_knn_imputed = train_data_knn_imputed['age_group']
    test_X_knn_imputed = test_data_knn_imputed.drop(columns=['age_group'])
    test_y_knn_imputed = test_data_knn_imputed['age_group']
    ...
    # CSV 파일로 결과 저장
    pth = '/userHome/userhome2/hyejin/paper_implementation/res/imputation_res/14_national_imputation_result.csv'
