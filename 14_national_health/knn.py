...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/paper_implementation/res/0_final/14_national_ensemble_method_res_final.csv'
...
for iteration in range(num_iterations):
    ...
    # 학습을 위한 데이터 준비
    train_X = train_data.drop(columns=['age_group'])
    train_y = train_data['age_group']
    test_X = test_data.drop(columns=['age_group'])
